...
import { Image, View, StatusBar, Dimensions, StyleSheet, Animated, Text } from 'react-native';
   ...
   return (
      <View style={{ flex: 1 }}>
         ...
         <View style={{ height: ITEM_HEIGHT, overflow: 'hidden' }}>
            <Animated.FlatList data={images} keyExtractor={(_, index) => index.toString()} snapToInterval={ITEM_HEIGHT}
            ...
            <View style={styles.pagination}>
               ...
               <Animated.View style={[styles.dotIndicator, { transform: [{ translateY }] }]} />
            </View>
         </View>
      </View>
   );
